...
const en: LocaleType = {
  ...
  Chat: {
    ...
    Documents: {
      Attached: (count: number) => `${count} document(s) attached`,
      ParseError: (name: string) => `Failed to parse document: ${name}`,
      Truncated: (name: string) => `Document was truncated: ${name}`,
      Limit: (count: number) => `You can attach up to ${count} documents`,
